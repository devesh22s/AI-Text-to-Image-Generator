...
const GenerateBtn = () => {
  ...
  return (
    <div className='pb-24 text-center relative z-10'>
        ...
        <button onClick={onclickhandler} className='inline-flex items-center gap-3 px-12 py-4 rounded-full bg-gradient-to-r from-purple-600 to-cyan-600 text-white font-bold text-lg hover:scale-105 hover:shadow-[0_0_40px_rgba(168,85,247,0.5)] transition-all duration-500' >
